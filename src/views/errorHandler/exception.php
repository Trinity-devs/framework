...
<body>
    <div class="header">
        <div class="tools">
            <label for="clipboard"></label><textarea id="clipboard"><?= $handler->htmlEncode($exception) ?></textarea>
