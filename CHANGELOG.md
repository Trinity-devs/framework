...
- Изменено:
  - Добавлена UserIdentity

## [ [0.9.0](https://github.com/Trinity-devs/framework/releases/tag/0.9.0) ] - 28.05.2024

- Изменено:
  - Изменена работа QueryBuilder
  - Перенесена UserIdentity

## [ [0.8.0](https://github.com/Trinity-devs/framework/releases/tag/0.8.0) ] - 27.05.2024

- Изменено:
  -  Обновлена работа с кэшем редиса

## [ [0.7.3](https://github.com/Trinity-devs/framework/releases/tag/0.7.3) ] - 24.03.2024
...
- Исправлено:
    - Исправлен валидатор длины строки
    - Теперь при вызове QueryBuilder происходит создание нового объекта

- Изменено:
    - Изменен принцип применения функционала пропуска незаполненных полей формы: для его активации необходимо в
      наследуемом классе переиспользовать свойство ```protected bool $skipOnEmpty = true```
